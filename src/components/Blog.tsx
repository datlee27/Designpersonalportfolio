      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-24">
          <motion.h2
            ...
            className="text-huge leading-none text-white uppercase"
          >
            LATEST<br />INSIGHTS
          </motion.h2>
          <div className="text-right hidden md:block">
            <Link
              to="/blog"
              className="group flex items-center gap-4 bg-white/5 border border-white/10 text-white px-8 py-4 font-heading text-2xl hover:bg-accent hover:text-ink transition-colors duration-100"
            >
