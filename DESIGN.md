...
## Mission
Create implementation-ready, token-driven UI guidance for Portfolio that is optimized for consistency, accessibility, and fast delivery across documentation site.
...
- Include known page component density: links (20), buttons (6), cards (1), navigation (1).
